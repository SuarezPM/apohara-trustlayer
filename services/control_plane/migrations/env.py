"""Alembic environment for TrustLayer control plane migrations.

Per Plan v1.2 Block 4 v1.2-US-1: async-compatible migrations using
...
# Override sqlalchemy.url from TL_DATABASE_URL env var if set.
db_url = os.environ.get("TL_DATABASE_URL")
if db_url:
