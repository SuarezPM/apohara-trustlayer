...
def validate_qtsp_certificate(cert_der: bytes) -> QESValidationResult:
    ...
    chain_root_fingerprint: str | None = None
...
class TrustListChainResult:
    ...
    chain_root_subject: str | None = None
